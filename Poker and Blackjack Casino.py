...
class Blackjack:
    ...
    def __init__(self, deck: List):
        ...
        """
        self.deck: List = deck
        self.rules: str = "Welcome to blackjack! You can choose to keep drawing cards until you either: reach 21 and " \
...
class Poker:
    def __init__(self, deck: List):
        ...
        """
        self.deck: List = deck
        self.rules: str = "Welcome to Poker! You can choose to between basic 5 card poker or Texas Holdem. Texas\n" \
                          "Holdem gives the player 2 cards, and reveals 3 cards from the deck. The player can\n" \
                          ...
                          "the cards from deck,alongside the cards in the hand. In basic poker,the poker rank is\n" \
